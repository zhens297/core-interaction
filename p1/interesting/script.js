document.addEventListener('DOMContentLoaded', function() {
    ...
    function skipTyping() {
        ...
        const uninterestingElement = document.querySelector('.interesting');
        uninterestingElement.style.animationDelay = '1.1s'; // Adjust animation delay
        ...
        if (skipClickCount === 2) {
            window.location.href = './period/index.html'; // Replace 'your-link-here' with your desired link
        }
    }
